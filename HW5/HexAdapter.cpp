#ifndef HEXADAPTER_CPP_
#define HEXADAPTER_CPP_
#include <iostream>
#include <vector>
#include <deque>
#include <string>
...
template <template<class...> class Storage, typename Element>
class HexAdapter : public AbstractHex {

public:

    HexAdapter() : AbstractHex(){ playGame(); }

    HexAdapter(int hexSize, int opponent) : AbstractHex(hexSize, opponent){
        createCells();
    }

    HexAdapter(const string& fileName) : AbstractHex(0, 0) {
        ifstream infile; 
    ...
    const Element& getCell(int row, int col) const { return hexCells[row][col]; } 

    ~HexAdapter(){ cout << "HexAdapter Destructor Called." << endl; }
    
private:
    //AI_POS_List posList;
    Storage<Storage<Element>> hexCells;
    //vector<FinalMove> movesMade;
    ...
    void createCells() {
        ...
        for (int i=0; i < size; ++i) {
            hexCells.push_back(Storage<Element>());
            for (int j=0; j < size; ++j) {
                hexCells[i].push_back(Element(i, j));
            }
        }
    }
    ...
    */
    ...
    /*
        ...
        return const string.
    */
    const string GetMove(bool& isCommand) const {
    ...
    */
    ...
    /*
        ...
        return bool
    */
    bool CheckP1(int row, int col, bool found = false) {
    ...
    /*
        ...
        return bool
    */
    bool CheckP2(int row, int col, bool found = false) {
    ...
    /*
        ...
        return bool
    */
    bool IsValidP1(const int& row, const int& col) {
    ...
    /*
        ...
        return bool
    */
    bool IsValidP2(const int& row, const int& col) {
...
public:
    ...
    */
    ...
    bool operator==(const AbstractHex& AH) {
